...
plt.close('all')  # Close all previously opened figures before starting new plots
import numpy as np
...
def main():
    ...
    plt.title("Throughput, LDPC Minsum Decoding, R=1/2", fontsize=25)
    plt.xlabel("Code Length, N", fontsize=25)
